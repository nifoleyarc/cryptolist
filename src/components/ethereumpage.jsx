...
const Ethereum = () => {
    ...
    return (
        <>
            ...
            <span className="wallet_name">Адрес кошелька Ethereum</span>
            ...
            <div id="search"><input id="input" readonly="readonly" value="2" /><button id="button" onClick={() => { Check(); iconClicked() }}><CopyIcon data-clipboard-target="#input" className="CopyIconc" width="17" /></button>
