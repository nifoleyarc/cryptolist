...
const Solana = () => {
    ...
    return (
        <>
            ...
            <span className="wallet_name">Адрес кошелька Solana</span>
            <span className="network_type">Сеть: <span className="type_color">SOL</span></span>
            <img className="qrcode eth" src={qrbtc} alt="QR Code Ethereum" width="200px"/>
            <div id="search"><input id="input" readonly="readonly" value="5" /><button id="button" onClick={() => { Check(); iconClicked() }}><CopyIcon data-clipboard-target="#input" className="CopyIconc" width="17" /></button>
